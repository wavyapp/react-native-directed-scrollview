...
RCT_EXPORT_VIEW_PROPERTY(onMoveShouldSetResponder, RCTDirectEventBlock)
RCT_EXPORT_VIEW_PROPERTY(onMoveShouldSetResponderCapture, RCTDirectEventBlock)
RCT_EXPORT_VIEW_PROPERTY(oonResponderGrant, RCTDirectEventBlock)
RCT_EXPORT_VIEW_PROPERTY(onResponderMove, RCTDirectEventBlock)
RCT_EXPORT_VIEW_PROPERTY(onResponderReject, RCTDirectEventBlock)
RCT_EXPORT_VIEW_PROPERTY(onResponderRelease, RCTDirectEventBlock)
RCT_EXPORT_VIEW_PROPERTY(onResponderTerminate, RCTDirectEventBlock)
RCT_EXPORT_VIEW_PROPERTY(onResponderTerminationRequest, RCTDirectEventBlock)
